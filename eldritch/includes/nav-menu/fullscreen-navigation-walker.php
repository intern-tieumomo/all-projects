...
if(!class_exists('EldritchEdgeFullscreenNavigationWalker')) {
	class EldritchEdgeFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
			...
			if($item->hide == "") {
                ...
                $item_output .= '<span class="edgt-strikethrough"></span>';
