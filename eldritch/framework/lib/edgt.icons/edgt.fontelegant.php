...
class EldritchEdgeIconsFontElegant implements iEldritchEdgeIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edgt-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
