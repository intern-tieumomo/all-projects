...
/**
 * Class EldritchEdgeDripicons
 */
class EldritchEdgeDripicons implements iEldritchEdgeIconCollection {
    /**
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edgt-icon-dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
