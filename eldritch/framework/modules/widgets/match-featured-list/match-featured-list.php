...
class EldritchEdgeMatchFeaturedList extends EldritchEdgeWidget {
	protected $params;

	public function __construct() {
		parent::__construct(
			'edgt_match_featured_list_widget', // Base ID
			esc_html__('Edge Match Featured List', 'eldritch'), // Name
	...
	protected function setParams() {
		$this->params = array(
            ...
            array(
                'name'    => 'show_result',
                'type'    => 'dropdown',
                'title'   => esc_html__('Show Result', 'eldritch'),
                'options' => array(
                    'no'  => esc_html__('No', 'eldritch'),
                    'yes' => esc_html__('Yes', 'eldritch'),
                )
	...
	public function widget($args, $instance) {
		...
		echo '<div class="widget edgt-match-featured-list-widget">';

		if (!empty($instance['title'])) {
			echo eldritch_edge_get_module_part($args['before_title'] . $instance['title'] . $args['after_title']);
		}

		echo eldritch_edge_execute_shortcode('edgt_match_featured', $params);
