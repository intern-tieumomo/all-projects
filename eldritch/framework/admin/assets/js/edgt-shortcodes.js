			...
			menu: [
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgt_blockquote text="' + e.data.text + '" title_tag="' + e.data.title_tag + '" width="' + e.data.width + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgt_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '"]'+ e.data.letter +'[/edgt_dropcaps]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgt_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '"]'+ e.data.text +'[/edgt_highlight]');
							}
						});
					}
				},
						...
						ed.windowManager.open( {
							...
							body: [
								...
								},
								{
									...
									label: 'Size',
									'values': [
										{text: 'Tiny', value: 'edgt-icon-tiny'},
										{text: 'Small', value: 'edgt-icon-small'},
										{text: 'Medium', value: 'edgt-icon-medium'},
										{text: 'Large', value: 'edgt-icon-large'},
										{text: 'Very Large', value: 'edgt-icon-huge'}
									]
								},
								{
									type: 'textbox',
				...
				},
				{
					text: 'Ordered List',
					onclick: function() {
						ed.insertContent('[edgt_list_ordered]<ol><li>Lorem Ipsum</li><li>Lorem Ipsum</li><li>Lorem Ipsum</li></ol>[/edgt_list_ordered]');
					}
				},
				{
					text: 'Unordered List',
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[edgt_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '" font_weight="' + e.data.font_weight + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/edgt_unordered_list]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[edgt_separator class_name="' + e.data.class_name + '" type="' + e.data.type + '" position="' + e.data.position + '" color="' + e.data.color + '" border_style="' + e.data.border_style + '" width="' + e.data.width + '" thickness="' + e.data.thickness + '" top_margin="' + e.data.top_margin + '" bottom_margin="' + e.data.bottom_margin + '"]');
							}
						});
					}
				},
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								...
								ed.insertContent('[edgt_icon_list_item icon_pack="' + e.data.icon_pack + '" ' + icon_pack_prefix + '="' + e.data.icon + '" icon_size="' + e.data.icon_size + '" icon_color="' + e.data.icon_color + '" title="' + e.data.title + '" title_color="' + e.data.title_color + '" title_size="' + e.data.title_size + '"]');
							}
						});
					}
				},
