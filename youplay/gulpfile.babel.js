...
gulp.task('html', () => {
    ...
    return gulp.src(gulpConfig.html.from)
        ...
        .pipe($.if(process.env.NODE_ENV === 'production', $.cdnizer({
...
gulp.task('production', (cb) => {
    ...
    $.sequence('clean', ['images'], ['html', 'css', 'js'], 'static', cb);
});
...
gulp.task('deploy', (cb) => {
    ...
    $.sequence('production', 'move-to-deploy-folder', 'copy-static-files', 'zip', cb);
});
